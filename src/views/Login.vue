      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          <div class="card-img-left d-none d-md-flex">
            <img src="../assets/logo.png" height="375" alt="" />
          </div>
          <div class="card-body">
            <h5 class="card-title text-center">Entre em sua conta</h5>
...
.card-signin {
  border: 0;
  border-radius: 1rem;
  box-shadow: 0 0.5rem 1rem 0 rgb(153, 9, 9, 0.1);
  overflow: hidden;
}
